...
<aside class="sidebar {collapsed ? 'collapsed' : ''}">
  <div class="sidebar-header">
    {#if !collapsed}
    <h2 class="header-title">Neurapp</h2>
    {/if}
    <button type="button" id="burger-button" on:click={toggleSidebar} aria-label="Toggle sidebar" style="background: none; border: none; padding: 0; cursor: pointer;">
  ...
  <nav>
    <ul>
      <li>
        <a href="/private/dashboard" aria-label="Dashboard">
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3.75 15C3.75 15.3315 3.8817 15.6495 4.11612 15.8839C4.35054 16.1183 4.66848 16.25 5 16.25H12.5C12.8315 16.25 13.1495 16.1183 13.3839 15.8839C13.6183 15.6495 13.75 15.3315 13.75 15V5C13.75 4.66848 13.6183 4.35054 13.3839 4.11612C13.1495 3.8817 12.8315 3.75 12.5 3.75H5C4.66848 3.75 4.35054 3.8817 4.11612 4.11612C3.8817 4.35054 3.75 4.66848 3.75 5V15ZM3.75 25C3.75 25.3315 3.8817 25.6495 4.11612 25.8839C4.35054 26.1183 4.66848 26.25 5 26.25H12.5C12.8315 26.25 13.1495 26.1183 13.3839 25.8839C13.6183 25.6495 13.75 25.3315 13.75 25V20C13.75 19.6685 13.6183 19.3505 13.3839 19.1161C13.1495 18.8817 12.8315 18.75 12.5 18.75H5C4.66848 18.75 4.35054 18.8817 4.11612 19.1161C3.8817 19.3505 3.75 19.6685 3.75 20V25ZM16.25 25C16.25 25.3315 16.3817 25.6495 16.6161 25.8839C16.8505 26.1183 17.1685 26.25 17.5 26.25H25C25.3315 26.25 25.6495 26.1183 25.8839 25.8839C26.1183 25.6495 26.25 25.3315 26.25 25V15C26.25 14.6685 26.1183 14.3505 25.8839 14.1161C25.6495 13.8817 25.3315 13.75 25 13.75H17.5C17.1685 13.75 16.8505 13.8817 16.6161 14.1161C16.3817 14.3505 16.25 14.6685 16.25 15V25ZM17.5 3.75C17.1685 3.75 16.8505 3.8817 16.6161 4.11612C16.3817 4.35054 16.25 4.66848 16.25 5V10C16.25 10.3315 16.3817 10.6495 16.6161 10.8839C16.8505 11.1183 17.1685 11.25 17.5 11.25H25C25.3315 11.25 25.6495 11.1183 25.8839 10.8839C26.1183 10.6495 26.25 10.3315 26.25 10V5C26.25 4.66848 26.1183 4.35054 25.8839 4.11612C25.6495 3.8817 25.3315 3.75 25 3.75H17.5Z" fill="#ffffff"/>
          </svg>
        </a>
        {#if !collapsed}
          <a class="texto" href="/private/dashboard">Dashboard</a>    
        {/if}
      </li>
      <li>
        <a class="texto" href="/private/pacientes" aria-label="Pacientes">
        ...
        {#if !collapsed}
        <a class="texto" href="/private/pacientes">Pacientes</a>
        {/if}
      </li>
      <li>
        <a href="/private/registro_pacientes" aria-label="Registro de pacientes">
