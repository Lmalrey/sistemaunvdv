...
<div class="content">
    <div class="header">
        <div class="left">
            <a class="back-button" href="/private/configuracion/antecedentes_familiares">←</a>
        </div>
        <div class="right">
        <h2>Editar Antecedente Familiar</h2>
        <p>Modificar Información del antecedente familiar existente</p>
        </div>
    </div>
    <div class="form">
        <h3>Editar antecedente familiar</h3>
