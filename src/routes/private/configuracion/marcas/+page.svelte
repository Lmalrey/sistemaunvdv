<script lang="ts">
    ...
    import type{MedicineBrand} from '$lib/server/database.js';
    ...
    const columns: ColumnDef<MedicineBrand>[] = [
        {
            accessorKey: 'id',
            header: 'ID',
        },
	...
	function handleEdit() {
		if(selectedItemId){
            goto(`/private/configuracion/marcas/${selectedItemId}/edit`)
        }
		closeActionsModal();
	}
...
{#snippet ActionsCell(marca: MedicineBrand)}
    <div class="actions-container">
        <button class="actions-button" onclick={()=>openActionsModal(marca.id)}>
        ...
        {#if isModalOpen && selectedItemId === marca.id}
...
<div class="container">
    <div class="content-section">
        <h3>Lista de Marcas de Medicamentos</h3>
        <p>Gestiona la lista de marcas de medicamentos disponibles en el sistema</p>
        <div class="actions-bar">
            ...
            <button class="add-button">
                <i class="fas fa-plus"></i> <a href="/private/configuracion/marcas/add">
                    Agregar marca
                </a>
            </button>
        </div>
