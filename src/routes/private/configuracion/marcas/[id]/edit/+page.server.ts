...
import { marcaSchema, editMarcaSchema } from '../../schema';
...
export const load: PageServerLoad = async ({ params }) => {
    ...
    const form = await superValidate(dataForForm, zod4(editMarcaSchema));
...
export const actions: Actions = {
    default: async ({ request, params }) => {
        ...
        throw redirect(303, '/private/configuracion/marcas');
    }
};