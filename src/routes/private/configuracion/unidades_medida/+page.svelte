<script lang="ts">
    ...
    import type{MeasurementUnit} from '$lib/server/database.js';
	...
	function handleEdit() {
		if(selectedItemId){
            goto(`/private/configuracion/unidades_medida/${selectedItemId}/edit`)
        }
		closeActionsModal();
	}
...
{#snippet ActionsCell(unidad: MeasurementUnit)}
    <div class="actions-container">
        <button class="actions-button" onclick={()=>openActionsModal(unidad.id)}>
        ...
        {#if isModalOpen && selectedItemId === unidad.id}
...
<div class="container">
    <div class="content-section">
        ...
        <p>Gestiona la lista de unidades de medida disponibles en el sistema</p>
        <div class="actions-bar">
            ...
            <button class="add-button">
                <i class="fas fa-plus"></i> <a href="/private/configuracion/unidades_medida/add">
